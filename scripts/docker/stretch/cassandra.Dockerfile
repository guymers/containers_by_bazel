...
RUN apt-key adv --no-tty --keyserver pool.sks-keyservers.net --recv-key 0xF8358FA2F2833C93
...
RUN apt-key adv --no-tty --keyserver pool.sks-keyservers.net --recv-key 0xA278B781FE4B2BDA
