...
POSTGRESQL_VERSION = POSTGRESQL_MINOR_VERSION + ".1-2"
...
TOMCAT7_DEB_VERSION = TOMCAT7_VERSION + "+deb8u6"

MAVEN_VERSION = "3.3.9"

PHP_VERSION = "7.0.14-2"

PROMETHEUS_VERSION = "1.4.1"

GRAFANA_VERSION = "4.0.2"
GRAFANA_DEB_VERSION = GRAFANA_VERSION + "-1481203731"
