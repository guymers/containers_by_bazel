...
POSTGRESQL_VERSION = POSTGRESQL_MINOR_VERSION + "." + "6-1"
...
GERRIT_VERSION = "2.14.6-1"
GERRIT_DEB_VERSION = GERRIT_VERSION

DNSMASQ_VERSION = "2.72-3"
DNSMASQ_DEB_VERSION = DNSMASQ_VERSION + "+deb8u2"

ERLANG_VERSION = "19.2.1"
ERLANG_DEB_VERSION = ERLANG_VERSION + "+dfsg-2+deb9u1~bpo8+1"

RABBITMQ_VERSION = "3.6.15-1"

EJABBERD_VERSION = "17.04"

ZIPKIN_VERSION = "2.4.0"

JENKINS_VERSION = "2.89.2"
JENKINS_SWARM_VERSION = "3.6"
