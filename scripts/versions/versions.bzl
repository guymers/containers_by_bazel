...
POSTGRESQL_VERSION = POSTGRESQL_MINOR_VERSION + "." + "0-1"
POSTGRESQL_DEB_VERSION = POSTGRESQL_VERSION + "." + "pgdg90+2"
...
POSTGIS_DEB_VERSION = POSTGIS_VERSION + "+dfsg-2.pgdg90+1"
