...
REDIS_VERSION = "3.2.5-4"
REDIS_DEB_VERSION = REDIS_VERSION + "~bpo8+1"

TOMCAT7_VERSION = "7.0.56-3"
TOMCAT7_DEB_VERSION = TOMCAT7_VERSION + "+deb8u5"

MAVEN_VERSION = "3.3.9"

PHP_VERSION = "7.0.12-1"

PROMETHEUS_VERSION = "1.2.3"
