...
http_file(
  name = "deb-libatk-wrapper-java-jni",
...
http_file(
  name = "deb-libboost-chrono1.55.0",
...
http_file(
  name = "deb-libboost-date-time1.55.0",
...
http_file(
  name = "deb-libboost-filesystem1.55.0",
...
http_file(
  name = "deb-libboost-program-options1.55.0",
...
http_file(
  name = "deb-libboost-serialization1.55.0",
...
http_file(
  name = "deb-libboost-system1.55.0",
...
http_file(
  name = "deb-libboost-thread1.55.0",
...
http_file(
  name = "deb-libgdk-pixbuf2.0-common",
...
http_file(
  name = "deb-libschroedinger-1.0-0",
...
http_file(
  name = "deb-libxine2-misc-plugins",
...
http_file(
  name = "deb-nodejs",
  url = "https://deb.nodesource.com/node_5.x/pool/main/n/nodejs/nodejs_5.5.0-1nodesource1~jessie1_amd64.deb",
  sha256 = "f48129b594288c752d3908482db5fb1875e7a09b71364a9026e639e0ec4bc010",
)
http_file(
  name = "deb-odbcinst",
...
http_file(
  name = "deb-postgresql-9.5-postgis-2.2",
...
http_file(
  name = "deb-postgresql-9.5-postgis-scripts",
...
http_file(
  name = "deb-postgresql-client-9.5",
...
http_file(
  name = "deb-postgresql-client-common",
...
http_file(
  name = "deb-postgresql-contrib-9.5",
